...
public class DBVerificationTest extends BaseClass {
	...
	public void verifyEmployeeNameVerificationFromDB(String emplID, String empName) {
		...
		BaseClass.logger.info("Verify the employee first and middle name");
